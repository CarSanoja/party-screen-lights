...
# 35 "./manager_temperature.h" 2
# 46 "./manager_temperature.h"
_Bool temperature_enable_flag;

int temperature_init(void);

_Bool temperature_get(void);
# 8 "manager_temperature.c" 2
